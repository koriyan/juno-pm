...
For customer signals, escalations, or transcript analysis, use:

Rank	Signal / Risk	Evidence	Source	Suggested Action

Keep it to the top 5 items.

Add these only when useful:

Key themes
Short summary of recurring patterns.

Open questions
Questions that need to be answered before moving forward.

Recommended next step
The most useful action for the PM to take next.
...
Mark missing information as TBD or ASSUMPTION.
